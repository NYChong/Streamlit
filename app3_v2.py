...
# load the model.pkl
path = r'C:\Users\User\Desktop\MTech EBAC\Data Science Solution Implementation\Day 2\Workshop\Streamlit\DSSI_app3-main\model.pkl'
...
def main():
	...
	# int rate min 5, max 25, default 10
